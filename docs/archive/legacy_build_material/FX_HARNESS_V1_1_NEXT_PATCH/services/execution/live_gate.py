...
from services.auth.approval import ApprovalPayload, verify_live_approval
from services.execution.policy import ExecutionPolicy, assert_safe_policy
...
class LiveGate:
    """Final deterministic gate before an execution adapter sees a live order."""
    ...
    def authorize(
        ...
        *,
        ...
        # At this point the caller may hand the immutable intent to the
        # isolated broker execution adapter. This method never imports an LLM.
